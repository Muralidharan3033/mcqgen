...
create a quiz  of {number} multiple choice questions for {subject} students in {tone} tone and dont wrap the words of the question using single quotes or double quotes. 
